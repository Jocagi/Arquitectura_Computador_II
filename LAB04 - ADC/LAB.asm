...
INICIO
	...
	MOVLW	B'00111111' 	;Valor 0 en display
...
SUBTRACTION
	...
	MOVLW	D'28'
    	SUBWF   DATO, 1		; Calcular: 28 - DATO
    	;ZERO Flag
	BTFSC   STATUS,Z
	GOTO	END_SUBTRACTION	; ZERO = 1: Por lo tanto DATO = 28
	NOP			; ZERO = 0: Por lo tanto DATO <> 28
    	;CARRY Flag
	BTFSS   STATUS,C
	GOTO	END_SUBTRACTION	; CARRY = 0: DATO < 28
	GOTO	SUBTRACTION	; CARRY = 1: DATO > 28
